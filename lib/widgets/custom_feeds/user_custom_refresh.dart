...
class UserCustomRefresh extends StatefulWidget {
  UserCustomRefresh({
    Key key,
    this.child,
    this.refresh,
  ...
  @override
  _UserCustomRefreshState createState() => _UserCustomRefreshState();
}

class _UserCustomRefreshState extends State<UserCustomRefresh> {
