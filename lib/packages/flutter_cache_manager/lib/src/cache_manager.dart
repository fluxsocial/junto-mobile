...
import 'package:junto_cache_manager/src/cache_store.dart';
import 'package:junto_cache_manager/src/storage/cache_object.dart';
import 'package:junto_cache_manager/src/web_helper.dart';
...
abstract class BaseCacheManager {
  ...
  Future<void> _pushFileToStream(StreamController<FileInfo> streamController,
