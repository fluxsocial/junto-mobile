...
class JuntoThemes {
  ...
  ThemeData fire = ThemeData(
    ...
    dividerColor: const Color(0xffeeeeee),
    backgroundColor: Colors.white,
    accentColor: const Color(0xFFDC7F56),
    colorScheme: const ColorScheme(
      primary: Color(0xffF2D094),
      primaryVariant: Color(0xffF2D094),
      secondary: Color(0xFFCE4E30),
      secondaryVariant: Color(0xFFCE4E30),
      surface: Color(0xff555555),
      background: Colors.white,
      error: Color(0xff333333),
      onPrimary: Colors.white,
  ...
  ThemeData forest = ThemeData(
    ...
    dividerColor: const Color(0xffeeeeee),
    backgroundColor: Colors.white,
    accentColor: const Color(0xFF409050),
    colorScheme: const ColorScheme(
...
// Night Theme
  ...
  ThemeData forestNight = ThemeData(
    ...
    dividerColor: const Color(0xff555555),
    backgroundColor: const Color(0xff333333),
    accentColor: const Color(0xFF439353),
    colorScheme: const ColorScheme(
      primary: Color(0xff67BA6F),
      primaryVariant: Color(0xff67BA6F),
      secondary: Color(0xFF2C7A40),
